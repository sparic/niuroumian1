...
import com.myee.domain.adempiere.service.CustomUserManager;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    @Autowired
    private CustomUserManager userManger;


    @Override
    public void configure(WebSecurity web) throws Exception {
        web.ignoring().antMatchers("/assets/**", "/weixin/**", "/wxmp/**", "/wxitf/**", "/weixin.html","/test.html");
    }
    ...
    protected void configure(AuthenticationManagerBuilder auth) throws Exception {
        auth.userDetailsService(userManger);
    }
